...
const ConsituencyModal = ({ subTitle, handleOpenModal, handleOpenEditModal, open, val }) => {
  ...
  useEffect(() => {
    setAccountId(generateUserId({ role: 'co', zone }));
  }, [zone]);
      ...
      >
        <Box style={{ width: '396px', padding: 30, backgroundColor: 'aliceblue', borderRadius: 10 }}>
          <FormControl fullWidth>
            ...
            <FormControl>
              <InputLabel id="select-label">Select Consituency</InputLabel>
              <Select
                labelId="select-label"
                id="select"
                value={zone}
...
export default ConsituencyModal;
